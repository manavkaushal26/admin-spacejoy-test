...
const OrderDelivered: React.FC<OrderDelivered> = ({
	firstName,
	address,
	selectedProducts,
	productTotal,
								...
								<td style={{ verticalAlign: "top" }}>
									<table className='responsive-spacing'>
										<tr>
											...
											>
												<p style={{ fontSize: "16px" }}>
													Your order has been <span className='font-big'>Delivered</span>, {firstName}.
												</p>
											</td>
										</tr>
										...
										<tr>
											...
											>
												<p>We have Fantastic News! The following items have been delivered to</p>
												<p style={{ width: "50%" }}>
													{firstName}, {address}
													<br />
												</p>
												<p>We’re so excited about your new space coming together.</p>
											</td>
										</tr>
										<tr>
											<td>
												...
												>
													<div
														style={{
															...
															textAlign: "center",
															fontFamily:
																"Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica, Arial, sans-serif",
										...
										<tr>
											<td>
												<br />
												<p>
													If you have any issues with the order please reach out to us at
													<a
													...
													or call us at (310) 483-7722. If you want to initiate either a return or an exchange please
													make sure to initiate it within what the retailer allows.
												</p>
											</td>
										</tr>
										<tr>
											<td>
												<span>
													<strong>In This Package </strong>
												</span>
												<hr className='hr-full' style={{ marginBottom: "8px" }} />
												<table
										...
										<tr>
											...
											>
												...
												<div className='' style={{ display: "inline-block", width: "38%", verticalAlign: "top" }}>
													<p>
				...
				<tr>
					<td>
						<table
							cellPadding='0'
							cellSpacing='0'
							style={{ marginTop: "14px", marginBottom: "14px", borderSpacing: "7px" }}
							className='tables'
						>
												...
												<td>
													...
													>
														<img
															...
															style={{ width: "22px", height: "22px", opacity: "0.6", paddingLeft: "1px" }}
														/>
													</a>
												</td>
												<td>
