				...
				<div className="grid">
					<div className="col-xs-12">
						...
						<p>
							...
							(&ldquo;us&rdquo; or &ldquo;we&rdquo;). This is a binding contract between you, an individual user
							(&ldquo;you&rdquo;) and us governing your use of {company.product} services (the &ldquo;Service&rdquo;)
							using the {company.product} website (the &ldquo;Website&rdquo;) and the {company.product} desktop/mobile
							application (the &ldquo;App&rdquo;). By registering to use the {company.product} and/or
							installing/accessing any portions of the {company.product}, you agree that you have read, understood, and
							agree to be bound by the EULA. If you do not agree, then you may not use the service. To have a copy of
							the EULA and the {company.product} Privacy Policy (the &ldquo;Privacy Policy&rdquo;) sent to you, contact{" "}
							{company.product} at <a href={`mailto:${company.email.support}`}>{company.email.support}</a>
						</p>
						<div className="grid">
							<div className="col-xs-12 col-md-6">
								...
								<p>
									...
									without warranties of any kind and {company.product}&apos;s liability to you is limited; disputes
							...
							<div className="col-xs-12 col-md-6">
								...
								<p>
									...
									that
									{company.product} has received your order. Please note that this does not mean that your Order has
									been accepted. Your Order constitutes an offer to {company.product} to avail the services. All orders
						...
						<p>
							...
							homeowners, renters, home stagers and commercial property owners in creating customised designs online. As
						...
						<h3>Right to Change/Update the EULA.</h3>
						<p>
							We may revise the EULA at any time to ensure that they comply with applicable law and remain consistent
							with our services and operations, by posting an updated version. We therefore reserve the right to update
							and revise these Terms at any time without specific or direct notice to You. You should visit this page
							periodically to review the most current EULA, because you are bound by it. Your continued use of the
							Service after a change to the EULA constitutes your binding acceptance of the EULA.
						</p>
						<h3>Third Party Fees.</h3>
						<p>
							Your may incur third party fees through use of the Service, such as fees charged by your Carrier for data
							usage. In addition, you may be subject to third party terms, through your use of the Service, such as your
							Carrier&#39;s terms of service. You acknowledge and agree that you are solely responsible for all such
							fees incurred by you for use of the Service, and you agree to pay all such fees and abide by all such
							terms.
						</p>
						<h3>Eligibility</h3>
						<p>
							organization (each a &quot;Subscribing Entity&quot;), then you represent and warrant that you: (i) are an
							authorized representative of that Subscribing Entity with the authority to bind such entity to the EULA
							and (ii) agree to be bound by the EULA on behalf of such Subscribing Entity. You must be over the age of
							13 to use the site and to use our service. No part of the Service is directed to persons under the age of
							13. If you are under 13 years of age, please do not use or access the service at any time or in any
							manner. If you are under 18 years of age, you represent and agree that you possess the legal consent of
							your parent or guardian to access and use the Service.
						</p>
						<h2>Scope of License to Users.</h2>
						<h3>License Grant to You.</h3>
						<p>
						...
						<h3>Limited License and Site Access.</h3>
						<p>
							...
							<ol>
								...
								<li>Make commercial use of any Content available on the Site;</li>
								<li>
								...
								<li> Directly rent, lease, lend, sell, redistribute or sublicense the Service</li>
								<li>
								...
								<li>Collect any information about users of the Site;</li>
								<li>
								...
								<li>Post advertising, marketing links or content;</li>
								<li> Access the Site from anywhere in the world where it is unlawful for You to do so.</li>
							</ol>
						...
						<p>
							...
							<a href={`mailto:${company.email.support}`}>{company.email.support}</a>. You will be solely responsible
							for the losses incurred by {company.product} and others due to any unauthorized use of your account.
						</p>
						<h2>Content You Submit; License Grants from You.</h2>
						<h3>Your Content</h3>
						<p>
						...
						<h3>License Grants to {company.product}.</h3>
						<p>
						...
						<h3>You Must Have Rights to the Content You Post.</h3>
						<p>
						...
						<p>
							<ol type="i">
								...
								<li>
									...
									email <a href={`mailto:${company.email.support}`}>{company.email.support}</a> to obtain a refund.
								</li>
								<li>
								...
								<li>
									...
									<a href={`mailto:${company.email.support}`}>{company.email.support}</a>). The merchandise credit may
									only apply to purchases over a certain cart total, the applicable cart total excludes sale items,
									non-qualified vendors, and shipping and tax.
								</li>
							</ol>
						</p>
						<h3>Third Party Materials; {company.product} Content.</h3>
						<p>
						...
						<h3>Your Use of the Service and Service Content.</h3>
						<p>
							...
							example and not limitation, by doing or engaging in any of the following without {company.product}&#39;s
							...
							<br />
							You agree not to access, tamper with, or use non-public areas of the Service, {company.product}&#39;s (and
							its hosting company&#39;s) computer systems and infrastructure, or the technical delivery systems of{" "}
							{company.product}&#39;s providers.
							<br />
							...
							written consent, if
							{company.product}
							has previously disabled an account of yours.
							<br />
						...
						<h3>Content and Intellectual Property Ownership.</h3>
						<p>
						...
						<h3>Consequences of Violating These Terms.</h3>
						<p>
						...
						<h3>{company.product}&#39;s Liability.</h3>
						<p>
						...
						<p>
							...
							liabilities, damages, judgements, losses, expenses or demands, including without limitation reasonable
							legal and accounting fees, alleging or resulting from
							<ol type="i">
						...
						<h3>Mobile Application Terms</h3>
						<p>
							{company.product} may make certain mobile applications available to you. The use of mobile applications
							either alone or in connection with the Services is governed by EULA. In addition, you must comply with all
							applicable third party terms of agreement when using the mobile applications (for example, any agreement
							with a wireless service or wireless data provider or the app store or other portal from where you
							downloaded the mobile application). You agree that EULA and the Privacy Policy are between you and{" "}
							{company.product} only, and that even if you receive access to {company.product} through Apple, Inc.’s App
							Store or any other source (collectively, the “Distributor”) for use on a mobile device, the Distributor
							has no liability or responsibility whatsoever to you related to
							{company.product}, whether by contract, warranty or otherwise, and although you will continue to be bound
							by the terms you agreed with such Distributor, you will look only to {company.product} for any support
							relating to the Services. You may use the
							{company.product}’s mobile application on a product that you own or control and as permitted by the usage
							rules set forth by the Distributor. The Distributor is not responsible for addressing any claims of any
							sort related to
							{company.product}, and you must address any claims directly with {company.product}. The Distributor and
							its subsidiaries have the right (and will be deemed to have accepted the right) to enforce these Terms
