...
function QuizStart() {
	const goToDesignMySpace = () => {
		Router.push({ pathname: "/designMySpace", query: { quiz: "1", plan: "free" } }, "/designMySpace?quiz=1");
	};
		...
		<div className="container">
			<div className="grid justify-center">
				<div className="col-12 col-md-6">
					...
					/>
					<Button variant="secondary" shape="flat" fill="ghost" onClick={goToDesignMySpace}>
